      ...
      <div className="grid md:grid-cols-3 gap-10 items-center max-w-6xl mx-auto">
        ...
        >
          <div className="space-y-2">
            <h1 className="text-3xl sm:text-4xl font-bold tracking-tight">M Uday Kiran Reddy Reddy</h1>
          ...
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-4 text-sm text-muted-foreground">
            <div className="flex items-center gap-1">
              ...
              <a href="mailto:udaykiran.mumchukota@gmail.com">udaykiran.muchukota@gmail.com</a>
            </div>
            <div className="flex items-center gap-1">
          ...
          <div className="flex flex-wrap gap-2 sm:gap-3">
            ...
            <Link
              href="https://github.com/Uday9126"
              target="_blank"
            >
            ...
            <Link
              href="mailto:udaykiran.muchukota@gmail.com"
              target="_blank"
            >
              <Button variant="outline" size="sm" className="text-xs sm:text-sm">
            ...
            <Link
              href="https://www.linkedin.com/in/uday-kiran-reddy-muchukota-804140274/"
              target="_blank"
            >
              <Button variant="outline" size="sm" className="text-xs sm:text-sm">
